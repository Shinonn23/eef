...
def import_controller(doctype):  # -> type[NestedSet] | type[Document] | type[BaseDocument]:
    ...
...
class BaseDocument:
    ...
    def get_valid_dict(
        self, sanitize=..., convert_dates_to_str=..., ignore_nulls=..., ignore_virtual=...
    ) -> _dict: ...
    ...
    def get_invalid_links(self, is_submittable=...):  # -> tuple[list[Any], list[Any]]:
    ...
    def throw_length_exceeded_error(self, df, max_length, value):  # -> None:
        ...
    def get_password(
        self, fieldname=..., raise_exception=...
    ...
    def get_formatted(
        self, fieldname, doc=..., currency=..., absolute_value=..., translated=..., format=...
    ): ...
