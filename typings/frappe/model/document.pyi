...
from typing import TYPE_CHECKING, Any, Optional, Self, TypeAlias, overload, override
...
def get_lazy_doc(doctype: str, name: str, *, for_update=...) -> Document: ...
...
class Document(BaseDocument):
    ...
    def check_docstatus_transition(self, to_docstatus):  # -> None:
    ...
    def validate_update_after_submit(self):  # -> None:
        ...
    def get_all_children(self, parenttype=...) -> list[Document]:
    ...
    @frappe.whitelist()
    def rename(self, name: str | int, merge=..., force=..., validate_rename=...):  # -> None:
        """Rename the document to `name`. This transforms the current object."""
        ...

    def delete(self, ignore_permissions=..., force=..., *, delete_permanently=...):
        """Delete document."""
        ...
    ...
    @frappe.whitelist()
    def add_comment(self, comment_type=..., text=..., comment_email=..., comment_by=...):  # -> _NewDocument:
    ...
    def log_error(self, title=..., message=...):  # -> _NewDocument | None:
...
def get_cached_value(
    doctype: str, name: str | dict, fieldname: str | Iterable[str] = ..., as_dict: bool = ...
) -> Any: ...
...
def get_last_doc(
    doctype, filters: FilterSignature | None = ..., order_by=..., *, for_update=...
):  # -> Document:
