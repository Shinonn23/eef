...
from typing import Any, Optional, TYPE_CHECKING, TypeAlias, overload
...
def new_doc(doctype: str, *, parent_doc: Optional[Document] = ..., parentfield: str | None = ..., as_dict: bool = ..., **kwargs) -> Document:
