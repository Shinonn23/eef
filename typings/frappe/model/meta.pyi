...
class Meta(Document):
    ...
    def process(self):  # -> None:
        ...
    def as_dict(self, no_nulls=...):  # -> dict[Any, Any]:
        ...
    ...
    def get_table_fields(self):  # -> list[_dict[Any, str]] | list[Any] | tuple[Any, ...] | Any | None:
        ...
    ...
    def get_fieldnames_with_value(self, with_field_meta=..., with_virtual_fields=...):  # -> list[Any]:
        ...
    def get_fields_to_check_permissions(
        self, user_permission_doctypes
    ):  # -> list[Any] | tuple[Any, ...] | Any | None:
        ...
    ...
    def get_permitted_fieldnames(
        self, parenttype=..., *, user=..., permission_type=..., with_virtual_fields=...
    ):  # -> list[Any] | list[str | Any]:
...
def get_parent_dt(
    dt,
):  # -> list[Any] | list[_dict[Any, Any]] | list[list[Any | None]] | dict[Any, Any] | _dict[Any, Any] | list[Any | None] | Literal['']:
    ...
