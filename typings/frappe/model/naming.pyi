...
def is_autoincremented(doctype: str, meta: Optional[Meta] = ...) -> bool:
...
def parse_naming_series(parts: list[str] | str, doctype=..., doc: Optional[Document] = ..., number_generator: Callable[[str, int], str] | None = ...) -> str:
