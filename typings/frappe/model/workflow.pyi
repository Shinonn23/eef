...
def get_workflow_name(
    doctype,
):  # -> list[Any] | list[_dict[Any, Any]] | list[list[Any | None]] | dict[Any, Any] | _dict[Any, Any] | list[Any | None] | Any | None:
    ...
@frappe.whitelist()
def get_transitions(
    doc: Document | str | dict, workflow: Workflow = ..., raise_exception: bool = ...
) -> list[dict]:
