...
@pass_context
def execute(context: CliCtxObj, method, args=..., kwargs=..., profile=...): # -> None:
	"Execute a function"
	...
...
@click.option("-f", "--format", "output", type=click.Choice(["plain", "table", "json", "legacy"]), help="Output format", default="legacy")
