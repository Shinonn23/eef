...
def extract_email_id(email):  # -> str:
...
def get_gravatar_url(email: str, default: Literal[mm, 404] = ...) -> str:
...
def get_request_session(max_retries=...):  # -> Session:
    ...
def markdown(text, sanitize=..., linkify=...):  # -> str:
    ...
...
def get_safe_filters(filters):  # -> str | Any | int | float:
    ...
