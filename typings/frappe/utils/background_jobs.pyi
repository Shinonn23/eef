...
def enqueue(method: str | Callable, queue: str = ..., timeout: int | None = ..., event: str | None = ..., is_async: bool = ..., job_name: str | None = ..., now: bool = ..., enqueue_after_commit: bool = ..., *, on_success: Callable | None = ..., on_failure: Callable | None = ..., at_front: bool = ..., job_id: str | None = ..., deduplicate=..., at_front_when_starved=..., **kwargs) -> Job | Any:
	"""
