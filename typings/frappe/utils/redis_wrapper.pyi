...
class RedisWrapper(redis.Redis):
    ...
    def get_value(
        self, key, generator=..., user=..., expires=..., shared=..., *, use_local_cache=...
    ):  # -> Any | None:
    ...
    def get_all(self, key):  # -> dict[Any, Any]:
        ...
    def get_keys(self, key):  # -> ResponseT | list[Any]:
    ...
    def lpush(self, key, value):  # -> Awaitable[int] | int:
        ...
    def rpush(self, key, value):  # -> Awaitable[int] | int:
        ...
    def lpop(self, key):  # -> Awaitable[str | List[Any] | None] | str | List[Any] | None:
        ...
    ...
    def hget(self, name, key, generator=..., shared=...):  # -> Any | None:
        ...
    def hdel(
        self, name: str, keys: str | list | tuple, shared=..., pipeline: redis.client.Pipeline | None = ...
    ):  # -> None:
        """
