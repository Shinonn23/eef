...
def msgprint(
    msg: str,
    title: str | None = ...,
    raise_exception: bool | type[Exception] | Exception = ...,
    as_table: bool = ...,
    as_list: bool = ...,
    indicator: Literal["blue", "green", "orange", "red", "yellow"] | None = ...,
    alert: bool = ...,
...
def toast(
    message: str, indicator: Literal["blue", "green", "orange", "red", "yellow"] | None = ...
):  # -> None:
    ...
