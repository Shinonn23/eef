...
_strip_html_tags = ...
def msgprint(msg: str, title: str | None = ..., raise_exception: bool | type[Exception] | Exception = ..., as_table: bool = ..., as_list: bool = ..., indicator: Literal["blue", "green", "orange", "red", "yellow"] | None = ..., alert: bool = ..., primary_action: dict | None = ..., is_minimizable: bool = ..., wide: bool = ..., *, realtime=...) -> None:
