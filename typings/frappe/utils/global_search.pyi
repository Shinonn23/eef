...
def get_doctypes_with_global_search(with_child_tables=...): # -> Any | None:
	"""
...
def get_selected_fields(meta, global_search_fields): # -> list[Any]:
	...

def get_children_data(doctype, meta): # -> tuple[_dict[Any, Any], _dict[Any, Any]]:
	"""
...
def get_routes_to_index(): # -> list[Any]:
	...
...
def sync_values(values: list): # -> None:
	...
...
@frappe.whitelist()
def search(text, start=..., limit=..., doctype=...): # -> list[Any]:
	"""
...
def web_search(text: str, scope: str | None = ..., start: int = ..., limit: int = ...): # -> list[Any]:
	"""
...
def get_distinct_words(text): # -> list[Any]:
	...
