...
def create_handler(
    module, site=..., max_size=..., file_count=..., stream_only=...
):  # -> list[Any] | list[StreamHandler[TextIO] | RotatingFileHandler]:
    """Create and return a Frappe-specific logging handler."""
    ...

def get_logger(
    module=..., with_more_info=..., allow_site=..., filter=..., max_size=..., file_count=..., stream_only=...
) -> logging.Logger:
