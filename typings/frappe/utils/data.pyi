...
def getdate(string_date: Optional[DateTimeLikeObject] = ..., parse_day_first: bool = ...) -> datetime.date | None:
	"""
...
def get_datetime(datetime_str: Optional[DateTimeLikeObject] | tuple | list = ...) -> datetime.datetime | None:
...
def get_timestamp(date: Optional[DateTimeLikeObject] = ...) -> float:
