...
def getdate(
    string_date: DateTimeLikeObject | None = ..., parse_day_first: bool = ...
) -> datetime.date | None:
    """
...
def get_quarter_ending(
    dt: DateTimeLikeObject | None = ..., as_str: Literal[False] = ...
) -> datetime.date: ...
@typing.overload
...
def cast_fieldtype(
    fieldtype, value, show_warning=...
):  # -> float | int | str | date | datetime | timedelta | None:
    ...
...
def __getattr__(name):  # -> None:
    ...
def money_in_words(
    number: str | float | int, main_currency: str | None = ..., fraction_currency: str | None = ...
):  # -> str:
...
def compare(val1: Any, condition: str, val2: Any, fieldtype: str | None = ...):  # -> Literal[False]:
    ...
...
def add_trackers_to_url(
    url: str, source: str, campaign: str | None = ..., medium: str | None = ..., content: str | None = ...
) -> str: ...
