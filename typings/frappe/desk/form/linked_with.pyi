...
@frappe.whitelist()
def get_submitted_linked_docs(doctype: str, name: str, ignore_doctypes_on_cancel_all=...) -> list[tuple]:
...
def get_referencing_documents(
    ...
    link_info: dict,
    get_parent_if_child_table_doc: bool = ...,
...
@frappe.whitelist()
def get(doctype, docname):  # -> dict[str, list[Any]]:
    ...
@frappe.whitelist()
def get_linked_doctypes(doctype, without_ignore_user_permissions_enabled=...):  # -> Any | None:
