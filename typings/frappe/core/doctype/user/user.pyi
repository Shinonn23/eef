...
class User(Document):
    ...
    def validate_reset_password(self):  # -> None:
        ...
    def reset_password(self, send_email=..., password_expired=...):  # -> str:
        ...
    ...
    def send_welcome_mail_to_user(self):  # -> None:
        ...
    def send_login_mail(self, subject, template, add_args, now=..., custom_template=...):  # -> None:
...
@frappe.whitelist()
def get_timezones():  # -> dict[str, set[str]]:
    ...
@frappe.whitelist()
...
@frappe.whitelist()
def get_roles(arg=...):  # -> list[str]:
    """get roles for a user"""
    ...

@frappe.whitelist()
def get_perm_info(role):  # -> list[Any]:
    """get permission info"""
    ...
...
def test_password_strength(
    new_password: str, key=..., old_password=..., user_data: tuple | None = ...
):  # -> dict[Any, Any] | _Result | None:
    ...
@frappe.whitelist()
def has_email_account(email: str):  # -> list[Any]:
    ...
@frappe.whitelist(allow_guest=False)
def get_email_awaiting(user):  # -> list[Any]:
    ...
...
def user_query(doctype, txt, searchfield, start, page_len, filters):  # -> list[Any]:
    ...
...
def get_system_users(
    exclude_users: Iterable[str] | str | None = ..., limit: int | None = ...
):  # -> list[Any]:
    ...
...
def get_restricted_ip_list(user):  # -> list[Any] | None:
    ...
@frappe.whitelist(methods=["POST"])
def generate_keys(user: str):  # -> dict[str, str]:
    """
