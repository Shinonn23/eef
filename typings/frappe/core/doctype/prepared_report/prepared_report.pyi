...
class PreparedReport(Document):
    ...
    def after_insert(self):  # -> None:
        ...
    def get_prepared_data(self, with_file_name=...):  # -> tuple[bytes, Any] | bytes | None:
        ...
...
def update_job_id(prepared_report):  # -> None:
    ...
@frappe.whitelist()
def make_prepared_report(report_name, filters=...):  # -> dict[str, Data | None]:
    """run reports in background"""
    ...

def process_filters_for_prepared_report(filters: dict[str, Any] | str) -> str: ...
@frappe.whitelist()
def get_reports_in_queued_state(report_name, filters):  # -> list[Any]:
    ...
def get_completed_prepared_report(
    filters, user, report_name
...
def has_permission(doc, user):  # -> bool:
    ...
@frappe.whitelist()
def enqueue_json_to_csv_conversion(prepared_report_name):  # -> None:
