...
def get_applicable_for_doctype_list(doctype, txt, searchfield, start, page_len, filters): # -> list[list[Any]]:
	...
...
@frappe.whitelist()
def check_applicable_doc_perm(user, doctype, docname): # -> Any | list[Any]:
	...
