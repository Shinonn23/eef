...
def get_extension(filename, extn: str | None = ..., content: bytes | None = ..., response: Optional[Response] = ...) -> str:
	...
...
def generate_file_name(name: str, suffix: str | None = ..., is_private: bool = ...) -> str:
