...
class DocType(Document):
    ...
    def get_permission_log_options(
        self, event=...
    ):  # -> dict[str, tuple[str, dict[str, tuple[str, str, str]]]] | None:
        ...
    ...
    def get_max_idx(
        self,
    ):  # -> str | Generator[Any | _dict[Incomplete | str | Any, Any] | list[Any], Any, None] | list[Any] | list[_dict[Any, Any]] | list[list[Any]] | Literal[0]:
