...
def get_doc_permissions(
    doc, user=..., ptype=..., debug=...
):  # -> dict[Any | None, int] | int | Any | dict[str, int]:
    """Return a dict of evaluated permissions for given `doc` like `{"read":1, "write":1}`"""
    ...

def get_role_permissions(doctype_meta, user=..., is_owner=..., debug=...):  # -> dict[str, int] | Any:
    """
...
def get_user_permissions(user):  # -> dict[Any, Any] | Any | _dict[Any, Any]:
    ...
def has_user_permission(doc, user=..., debug=..., *, ptype=...):
...
def get_doctypes_with_read():  # -> list[str]:
    ...
...
def add_user_permission(
    doctype, name, user, ignore_permissions=..., applicable_for=..., is_default=..., hide_descendants=...
):  # -> None:
    """Add user permission"""
    ...
...
def can_import(doctype, raise_exception=...):  # -> bool:
    ...
def can_export(doctype, raise_exception=..., is_owner=...):  # -> Literal[True]:
    ...
def update_permission_property(
    doctype, role, permlevel, ptype, value=..., validate=..., if_owner=...
):  # -> Literal[True] | None:
...
def has_child_permission(
    child_doctype, ptype=..., child_doc=..., user=..., parent_doctype=..., *, debug=..., print_logs=...
) -> bool: ...
