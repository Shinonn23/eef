...
def get_rendered_template(doc: Document, print_format: Optional[PrintFormat] = ..., meta: Meta = ..., no_letterhead: bool | None = ..., letterhead: str | None = ..., trigger_print: bool = ..., settings: dict | None = ...) -> str:
	...

def set_link_titles(doc: Document) -> None:
	...

def set_title_values_for_link_and_dynamic_link_fields(meta: Meta, doc: Document, parent_doc: Optional[Document] = ...) -> None:
	...
...
def get_print_style(style: str | None = ..., print_format: Optional[PrintFormat] = ..., for_legacy: bool = ...) -> str:
	...

def get_font(print_settings: PrintSettings, print_format: Optional[PrintFormat] = ..., for_legacy=...) -> str:
	...
