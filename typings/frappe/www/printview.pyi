...
def set_title_values_for_link_and_dynamic_link_fields(
    meta: Meta, doc: Document, parent_doc: Document | None = ...
) -> None: ...
...
def get_print_style(
    style: str | None = ..., print_format: PrintFormat | None = ..., for_legacy: bool = ...
) -> str: ...
def get_font(
    print_settings: PrintSettings, print_format: PrintFormat | None = ..., for_legacy=...
) -> str: ...
