...
):  # -> PostgresDatabase | SQLiteDatabase | frappe.database.mariadb.mysqlclient.MariaDBDatabase | frappe.database.mariadb.database.MariaDBDatabase:
    ...
def get_command(
    socket=..., host=..., port=..., user=..., password=..., db_name=..., extra=..., dump=...
):  # -> tuple[str | None, list[str], Literal['mariadb-dump', 'mariadb', 'sqlite3', 'pg_dump', 'psql']]:
    ...
