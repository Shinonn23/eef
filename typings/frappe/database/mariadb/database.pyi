...
class MariaDBExceptionUtil:
    ...
    @staticmethod
    def is_interface_error(e: pymysql.Error):  # -> bool:
        ...

class MariaDBConnectionUtil:
    def get_connection(self):  # -> Connection[Cursor]:
        ...
    def create_connection(self):  # -> Connection[Cursor]:
        ...
...
class MariaDBDatabase(MariaDBConnectionUtil, MariaDBExceptionUtil, Database):
    ...
    def change_column_type(
        self, doctype: str, column: str, type: str, nullable: bool = ...
    ) -> list | tuple: ...
