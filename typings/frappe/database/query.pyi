...
class Engine:
    ...
    def apply_fields(self, fields):  # -> None:
        ...
    def apply_filters(
        self, filters: dict[str, FilterValue] | FilterValue | list[list | FilterValue] | None = ...
    ):  # -> None:
        ...
    ...
    ):  # -> tuple[list[Any], Literal[False]] | tuple[list[Any], Literal[True]]:
...
class DynamicTableField:
    def __init__(
        self, doctype: str, fieldname: str, parent_doctype: str, alias: str | None = ...
    ) -> None: ...
    def __str__(self) -> str: ...
    @staticmethod
    def parse(
        field: str, doctype: str, allow_tab_notation: bool = ...
    ):  # -> ChildTableField | LinkTableField | None:
        ...
...
class LinkTableField(DynamicTableField):
    def __init__(
        self, doctype: str, fieldname: str, parent_doctype: str, link_fieldname: str, alias: str | None = ...
    ) -> None: ...
    def apply_select(self, query: QueryBuilder) -> QueryBuilder: ...
    def apply_join(self, query: QueryBuilder) -> QueryBuilder: ...
