...
class Database:
    ...
    def sql_list(
        self, query, values=..., debug=..., **kwargs
    ):  # -> str | tuple[()] | Generator[Any | _dict[Incomplete | str | Any, Any] | list[Any], Any, None] | list[Any] | list[_dict[Any, Any]] | list[list[Any]] | tuple[tuple[Any, ...]] | None:
    ...
    def get_description(
        self,
    ):  # -> Incomplete | tuple[str, ...] | tuple[tuple[str, None, None, None, None, None, None], ...]:
    ...
    def get(
        self, doctype, filters=..., as_dict=..., cache=...
    ...
    def get_value(
        self,
        doctype: str,
        filters: FilterValue | dict | list | None = ...,
    ...
    def get_values(
        ...
        *,
        ...
        skip_locked: bool = ...,
        wait: bool = ...,
    ):  # -> list[Any] | list[_dict[Any, Any]] | list[list[Any | None]] | dict[Any, Any] | None:
    ...
    def get_values_from_single(
        ...
        *,
        ...
        pluck=...,
        distinct=...,
    ):  # -> list[Any] | list[_dict[Any, Any]] | list[list[Any | None]] | None:
    ...
    def get_single_value(
        self, doctype: str, fieldname: str, cache: bool = ..., *, debug=..., for_update=..., run=...
    ):  # -> int | str | date | datetime | timedelta | None:
