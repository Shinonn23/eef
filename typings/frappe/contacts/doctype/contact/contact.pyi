...
@frappe.whitelist()
def get_contact_details(contact): # -> dict[str, list[Any] | tuple[Any, ...] | Any | None]:
	...
...
def contact_query(doctype, txt, searchfield, start, page_len, filters): # -> list[Any] | str | tuple[()] | Generator[Any | _dict[Incomplete | str | Any, Any] | list[Any], Any, None] | list[_dict[Any, Any]] | list[list[Any]] | tuple[tuple[Any, ...]] | None:
	...

@frappe.whitelist()
def address_query(links): # -> list[Any]:
	...
