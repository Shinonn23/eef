...
):  # -> list[Any] | str | tuple[()] | Generator[Any | _dict[Incomplete | str | Any, Any] | list[Any], Any, None] | list[_dict[Any, Any]] | list[list[Any]] | tuple[tuple[Any, ...]] | None:
    ...
@frappe.whitelist()
...
def get_full_name(
    first: str | None = ..., middle: str | None = ..., last: str | None = ..., company: str | None = ...
) -> str: ...
