...
):  # -> _dict[Any, Any] | list[Any | None] | dict[Any, Any] | None:
...
):  # -> list[Any] | tuple[Any, ...] | Any | str | None:
...
def is_document_amended(
    doctype: str, docname: str
):  # -> list[Any] | list[_dict[Any, Any]] | list[list[Any | None]] | dict[Any, Any] | _dict[Any, Any] | list[Any | None] | Literal[False] | None:
    ...
@frappe.whitelist()
