...
if TYPE_CHECKING:
	...
@frappe.whitelist()
def get_list(doctype, fields=..., filters=..., group_by=..., order_by=..., limit_start=..., limit_page_length=..., parent=..., debug: bool = ..., as_dict: bool = ..., or_filters=...): # -> list[Any]:
...
@frappe.whitelist()
def get(doctype, name=..., filters=..., parent=...): # -> dict[Any, Any]:
...
@frappe.whitelist()
def get_value(doctype, fieldname, filters=..., as_dict=..., debug=..., parent=...): # -> _dict[Any, Any] | list[Any | None] | dict[Any, Any] | None:
...
@frappe.whitelist()
def get_single_value(doctype, field): # -> int | str | date | datetime | timedelta | None:
	...

@frappe.whitelist(methods=["POST", "PUT"])
def set_value(doctype, name, fieldname, value=...): # -> dict[Any, Any]:
...
@frappe.whitelist(methods=["POST", "PUT"])
def insert_many(docs=...): # -> list[Data | None]:
...
@frappe.whitelist(methods=["POST", "PUT"])
def rename_doc(doctype, old_name, new_name, merge=...): # -> str:
	"""Rename document
...
@frappe.whitelist(methods=["POST", "PUT"])
def cancel(doctype, name): # -> dict[Any, Any]:
	"""Cancel a document
...
@frappe.whitelist(methods=["POST", "PUT"])
def bulk_update(docs): # -> dict[str, list[Any]]:
...
@frappe.whitelist()
def has_permission(doctype: str, docname: str, perm_type: str = ...): # -> dict[str, bool]:
...
@frappe.whitelist()
def get_password(doctype: str, name: str, fieldname: str): # -> list[Any] | tuple[Any, ...] | Any | str | None:
...
@frappe.whitelist(methods=["POST", "PUT"])
def attach_file(filename=..., filedata=..., doctype=..., docname=..., folder=..., decode_base64=..., is_private=..., docfield=...): # -> _NewDocument:
...
def is_document_amended(doctype: str, docname: str): # -> list[Any] | list[_dict[Any, Any]] | list[list[Any | None]] | dict[Any, Any] | _dict[Any, Any] | list[Any | None] | Literal[False] | None:
	...

@frappe.whitelist()
def validate_link(doctype: str, docname: str, fields=...): # -> _dict[Any, Any]:
	...
