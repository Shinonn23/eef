...
def get_formatted_html(subject, message, footer=..., print_html=..., email_account=..., header=..., unsubscribe_link: frappe._dict | None = ..., sender=..., with_container=...):
	...
...
def replace_filename_with_cid(message): # -> tuple[Any | str, list[Any]]:
