...
class EmailAccount(Document):
    ...
    def validate_frappe_mail_settings(self):  # -> None:
        ...
    def validate_smtp_conn(self):  # -> SMTP | SMTP_SSL | None:
        ...
    ...
    def find_outgoing(
        cls, match_by_email=..., match_by_doctype=..., _raise_error=...
    ):  # -> dict[str | Any, EmailAccount] | dict[Any, EmailAccount] | dict[str, EmailAccount] | None:
    ...
    @classmethod
    def find_incoming(cls, match_by_email=..., match_by_doctype=...):  # -> EmailAccount:
