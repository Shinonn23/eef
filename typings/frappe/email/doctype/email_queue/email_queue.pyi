...
class EmailQueue(Document):
    ...
    def get_email_account(
        self, raise_error=...
    ):  # -> Document | dict[str | Any, EmailAccount] | dict[Any, EmailAccount] | dict[str, EmailAccount] | None:
        ...
    ...
    def send(
        self,
        smtp_server_instance: SMTPServer = ...,
        frappe_mail_client: FrappeMail = ...,
        force_send: bool = ...,
    ):  # -> None:
...
class SendMailContext:
    ...
    def update_recipient_status_to_sent(self, recipient):  # -> None:
        ...
    def get_message_object(self, message):  # -> EmailMessage:
        ...
...
def retry_sending(queues: str | list[str]):  # -> None:
    ...
@frappe.whitelist()
def send_now(name, force_send: bool = ...):  # -> None:
    ...
@frappe.whitelist()
