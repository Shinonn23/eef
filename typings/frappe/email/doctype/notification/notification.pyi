...
class Notification(Document):
	if TYPE_CHECKING:
		...
		enabled: DF.Check
		event: DF.Literal["", New, Save, Submit, Cancel, "Days After", "Days Before", "Minutes After", "Minutes Before", "Value Change", Method, Custom,]
	...
	@frappe.whitelist()
	def preview_meets_condition(self, preview_document): # -> str | None:
		...
	
	@frappe.whitelist()
	def preview_message(self, preview_document): # -> str | Any | None:
		...
	
	@frappe.whitelist()
	def preview_subject(self, preview_document): # -> str | Any | None:
		...
	...
	def get_attachment(self, doc): # -> list[dict[str, Any]] | None:
		"""check print settings are attach the pdf"""
		...
	
	def get_template(self, md_as_html=...): # -> str | None:
		...
...
@frappe.whitelist()
def get_documents_for_today(notification): # -> list[Any]:
	...
