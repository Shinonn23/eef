...
def get_number_format(language: str | None = ...) -> NumberFormat:
...
def get_date_format(language: str | None = ...) -> str:
...
def get_time_format(language: str | None = ...) -> str:
...
def get_first_day_of_the_week(language: str | None = ...) -> str:
...
def get_locale_value(key: str, language: str | None = ...) -> str | None:
