...
class HTTPRequest:
    ...
    def set_lang(self):  # -> None:
        ...
    def is_allowed_referrer(self):  # -> bool | Literal[''] | None:
        ...
...
class LoginManager:
    ...
    def clear_preferred_language(self):  # -> None:
        ...
    def make_session(
        self, resume: bool = ..., session_end: str | None = ..., audit_user: str | None = ...
    ):  # -> None:
        ...
...
class CookieManager:
    ...
    def init_cookies(self):  # -> None:
        ...
    def set_cookie(
        self, key, value, expires=..., secure=..., httponly=..., samesite=..., max_age=..., deduplicate=...
    ):  # -> None:
        ...
