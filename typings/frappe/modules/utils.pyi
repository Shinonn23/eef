...
def export_customizations(
    module: str, doctype: str, sync_on_migrate: bool = ..., with_permissions: bool = ...
):  # -> str | None:
...
def get_module_name(
    doctype: str, module: str, prefix: str = ..., suffix: str = ..., app: str | None = ...
):  # -> str:
    ...
def get_module_app(module: str) -> str: ...
def get_app_publisher(module: str) -> str: ...
def make_boilerplate(
    template: str, doc: Document | frappe._dict, opts: dict | frappe._dict = ...
):  # -> None:
    ...
