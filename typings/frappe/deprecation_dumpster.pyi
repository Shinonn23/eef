...
def deprecated(
    original: str, marked: str, graduation: str, msg: str, stacklevel: int = ...
):  # -> Callable[..., Any]:
...
def test_runner_get_modules(doctype):  # -> tuple[str, ModuleType]:
    ...
@deprecated(
...
def tests_change_settings(*args, **kwargs):  # -> _GeneratorContextManager[Any, None, None]:
    ...
@deprecated(
...
def tests_patch_hooks(*args, **kwargs):  # -> _GeneratorContextManager[Any, None, None]:
    ...
@deprecated(
    "frappe.tests.utils.debug_on", "2024-20-08", "v17", "use `frappe.tests.debug_on` or the cls.debug_on"
)
def tests_debug_on(*args, **kwargs):  # -> _GeneratorContextManager[Any, None, None]:
    ...
@deprecated(
    "frappe.tests.utils.timeout", "2024-20-08", "v17", "use `frappe.tests.timeout` or the cls.timeout"
)
def tests_timeout(
    *args, **kwargs
