...
def get_app_translations(): # -> dict[str, str]:
	...
...
def get_messages_from_doctype(name): # -> list[tuple[Any, Any]]:
...
@frappe.whitelist()
def update_translations_for_source(source=..., translation_dict=...): # -> list[Any] | list[_dict[Any, Any]] | list[list[Any | None]] | dict[Any, Any] | None:
	...
