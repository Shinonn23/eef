...
def accept(web_form, data):  # -> Document:
    """Save the web form"""
    ...
...
def delete(web_form_name: str, docname: str | int):  # -> None:
    ...
@frappe.whitelist()
def delete_multiple(web_form_name: str, docnames):  # -> None:
    ...
...
@frappe.whitelist(allow_guest=True)
def get_form_data(
    doctype: str, docname: str | None = ..., web_form_name: str | None = ...
):  # -> _dict[Any, Any]:
    ...
@frappe.whitelist()
def get_in_list_view_fields(doctype):  # -> list[dict[str, str] | Any]:
    ...
def get_link_options(
    web_form_name, doctype, allow_read_on_all_link_options=...
