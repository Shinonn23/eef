...
class PathResolver:
    ...
    def resolve(
        self,
    ):  # -> tuple[Literal['app'], TemplatePage] | tuple[Any, NotFoundPage] | tuple[Any | None, RedirectPage] | tuple[str, RedirectPage] | tuple[Any | str | LiteralString | None, Any] | tuple[Any | str | LiteralString | None, NotFoundPage]:
