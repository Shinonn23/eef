...
class OAuthWebRequestValidator(RequestValidator):
	...
	def get_default_redirect_uri(self, client_id, request, *args, **kwargs): # -> list[Any] | list[_dict[Any, Any]] | list[list[Any | None]] | dict[Any, Any] | _dict[Any, Any] | list[Any | None] | None:
		...
	...
	def confirm_redirect_uri(self, client_id, code, redirect_uri, client, *args, **kwargs): # -> bool:
		...
	
	def validate_grant_type(self, client_id, grant_type, client, request, *args, **kwargs): # -> bool:
		...
	
	def save_bearer_token(self, token, request, *args, **kwargs): # -> list[Any] | list[_dict[Any, Any]] | list[list[Any | None]] | dict[Any, Any] | _dict[Any, Any] | list[Any | None] | None:
		...
	...
	def get_authorization_code_nonce(self, client_id, code, redirect_uri, request): # -> Any | None:
		...
	
	def get_authorization_code_scopes(self, client_id, code, redirect_uri, request): # -> Any | list[Any]:
		...
	
	def get_jwt_bearer_token(self, token, token_handler, request):
		...
	
	def get_userinfo_claims(self, request): # -> _dict[str, Any | list[Any] | list[_dict[Any, Any]] | list[list[Any | None]] | dict[Any, Any] | _dict[Any, Any] | list[Any | None] | str | list[str] | None]:
		...
...
def get_cookie_dict_from_headers(r): # -> BaseCookie[Any]:
	...
...
def get_userinfo(user): # -> _dict[str, Any | list[Any] | list[_dict[Any, Any]] | list[list[Any | None]] | dict[Any, Any] | _dict[Any, Any] | list[Any | None] | str | list[str] | None]:
	...
